                    ...
                    <ul className="nav navbar-nav menu-bar">
                      ...
                      <li>
                        ...
                        <ul className="sub-menu">
                          <li>
                            <a href="gallerypage01.html">masonry</a>
                          </li>
                          <li>
                            <a href="gallery02.html">gallery column two</a>
                          </li>
                          <li>
                            <a href="gallery03.html">gallery column 03</a>
                          </li>
                        </ul>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <ul className="sub-menu">
                          <li>
                            <a href="400.html">400 page</a>
                          </li>
                          <li>
                            <a href="401.html">401 page</a>
                          </li>
                          <li>
