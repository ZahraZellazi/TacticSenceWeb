    ...
    return (
        <div className="banner" id="layerSlider" style={{ width: "100%" }}>
            <div className="ls-slide" data-ls="transition3d: 33,15; slidedelay: 8000 ; durationin:0;">
                ...
                <img src={backParticles} alt="particles" className="ls-l"
                ...
                <h2 className="ls-l bannertext01 italic01 layercontent04"
                    data-ls="offsetxin:left; scalexin:9; durationin: 4000;">
                    starts
                </h2>
                <h4 className="ls-l bannertext02 layercontent05"
                    data-ls="offsetxin:left; rotatexin:90 ; durationin: 4500;">
                    from
                </h4>

                <h2 className="ls-l bannertext01 layercontent06"
                    style={{ left: "87%", top: "760px" }}
                    data-ls="offsetxin:left; flipxin:90 ; durationin: 5000;">
                    21<sup>st</sup>
                </h2>

                <h6 className="ls-l bannertext03 layercontent07"
        ...
        <>
         <Banner/>
            ...
            <section className="booking bg-smallwhite">
                <div className="container">
                    ...
                    <div className="booking-content">
                        ...
                        <a href="bookTicket.html" className="btn btn-red">Book My Ticket</a>
                    </div>
                </div>
            </section>
            ...
            <section className="about">
                <div className="container">
                    <div className="row">
                        <h2 className="heading">About <span>SCC</span></h2>

                        <div className="about-wrap">
                            <div className="tab-content nav-content">
                                <p role="tabpanel" className="tab-pane fade" id="matches">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim amet cumque quo at eius nulla,
                                    voluptates assumenda saepe, consequatur fuga sapiente. Quas optio adipisci dolor possimus quos,
                                    maiores aliquid placeat! Nemo ab praesentium voluptatum, exercitationem ad quo tempore quam
                                    temporibus voluptates odio, qui laborum pariatur perferendis! Sapiente, itaque facilis deleniti unde?
                                </p>

                                <p role="tabpanel" className="tab-pane active fade in" id="static">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim amet cumque quo at eius nulla,
                                    voluptates aliquid placeat! Nemo ab praesentium voluptatum, exercitationem ad quo tempore quam
                                    temporibus voluptates odio, qui laborum pariatur perferendis! Sapiente, itaque facilis deleniti unde?
                                </p>

                                <p role="tabpanel" className="tab-pane fade" id="traning">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos, maiores aliquid placeat! Esse nemo ab
                                    praesentium voluptatum, exercitationem ad quo tempore quam temporibus voluptates odio, qui laborum
                                    pariatur perferendis! Sapiente, itaque facilis deleniti unde? Aspernatur expedita recusandae ullam
                                    autem ducimus consectetur sed iure sequi ratione architecto optio consequuntur atque dolor dolores
                                    asperiores illum, quam hic ab?
                                </p>
                            </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="latestResult-wrap">
                            ...
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim, nemo tenetur magnam eveniet sed aut...
                            </p>
                        </div>
                                ...
                                <div className="figure">
                                    <div className="team-logo">
                                        <div
                                            ...
                                            style={{ backgroundImage: 'url(images/team-logo/logo01.png)' }}
                                        ></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="result-details">
                                ...
                                <div className="figure figresult">
                                    <div className="team-logo">
                                        <div
                                            className="teamLogoImg"
                                            style={{ backgroundImage: 'url(images/team-logo/logo02.png)' }}
                                        ></div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        {[
                                            ...
                                            <li className="clearfix" key={index}>
                                                <div className="subPoint_table">
                                                    <div className="headline01 smallpoint">{index + 1}</div>
    ...
    return (
        <>
            ...
            <section className="latestvideo">
                <div className="container">
                    <div className="row">
                        <h2 className="heading">latest <span>video</span></h2>
                        <p className="headParagraph">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil debitis mollitia
                        ...
                        <div className="video-wrap clearfix">
                            <div className="video-content clearfix">
                                ...
                                <ul className="videoLive clearfix" id="videoSlide" role="tablist">
                                    {[
                                        'W7qWa52k-nE',
                                        'YtXNB-0cFBo',
                                        'W7qWa52k-nE',
                                        ...
                                        <li key={index}>
                                            <a className="changeVideo" data-yt-video={videoId} href="#">
                                                <div>
                                                    <span>september 10, 2015</span> consectetur adipisicing elit :
                            ...
                            <div className="video-show">
                                <div className="video-container" id="video01" data-current-video="W7qWa52k-nE">
                                    <iframe
        ...
        <section className="latest_news bg-white">
            <div className="container">
                <div className="row">
                    ...
                    <p className="headParagraph">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil debitis mollitia qui libero
                        voluptate ratione, molestias! Necessitatibus voluptatem temporibus doloremque non, vel ipsam,
                        nesciunt dolores consequatur, est tempora ut! Est Lorem ipsum dolor sit amet, consectetur
                        adipisicing elit. Nihil debitis mollitia qui libero voluptate ratione, molestias! Necessitatibus
                        voluptatem temporibus doloremque non, vel ipsam, nesciunt dolores consequatur, est tempora ut!
                        Est.
                    </p>
                    ...
                    <div className="LatestNews_wrap clearfix">
                        <ul className="nav accordion-news" role="tablist">
                            <li>
                                <a href="#world_news" aria-controls="world_news" role="tab" data-toggle="tab" id="world_news_button">
                                    world news
                                </a>
                            </li>
                            <li className="active">
                                <a href="#club_news" aria-controls="club_news" role="tab" data-toggle="tab" id="club_news_button">
                                    club news
                                </a>
                            </li>
                        </ul>
                                    ...
                                    <div className="figure">
                                        <div className="column-news">
                                            ...
                                            <div className="content-01">
                                                ...
                                                <p className="describtion">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                                            </div>
                                            <div className="news_date clearfix">
                                                <span>october 14,2015</span> <span className="like"><a href="#">45</a></span>
                                            </div>
                                        </div>
                                    </div>
                                </li>
        ...
        <section className="club_history">
            <div className="container">
                <div className="row">
                    ...
                    <p className="headParagraph">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis consequuntur animi, commodi,
                        voluptatibus labore aperiam fugit maxime quos optio architecto cum? Laborum nesciunt doloribus
                        ...
                        <div className="tab-content historyVideoWrap clearfix">
                            <div role="tabpanel" className="tab-pane clearfix" id="win01">
                                ...
                                <div className="historyContent">
                                    ...
                                    <p>
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam non voluptatibus error a esse
                                        maiores, ducimus sit unde alias aspernatur perspiciatis itaque corporis? Accusamus pariatur
                                        dolorum repellendus consectetur tempore harum? Lorem ipsum dolor sit amet, consectetur adipisicing
                                        elit. Praesentium a modi atque reprehenderit eos, error impedit voluptatum quo quaerat placeat
                                        accusantium molestiae quod dolore, quae quos, blanditiis recusandae id iste? Lorem ipsum dolor sit
                                        amet, consectetur adipisicing elit. Praesentium a modi atque reprehenderit.
                                    </p>
                                    <a href="clubHistoryDetails.html" className="btn-small btn-red">
                                        Read more
                                    </a>
                                </div>
                            </div>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <p className="headParagraph">
                        ...
                        Laborum nesciunt doloribus expedita atque error rem molestias, ducimus.
                    </p>
                    ...
                    <div className="wrapplayer clearfix">
                        ...
                        <ul className="slideHeroes clearfix">
                            {[
                                { name: "Daren Difiore", role: "Goalkeeper", age: 28, image: player01, loveCount: 20 },
                                { name: "Terry Tijerina", role: "Defender", age: 28, image: player02, loveCount: 34 },
                                { name: "Alex Alameda", role: "Striker", age: 28, image: player03, loveCount: 45 },
                                { name: "Lane Lavalley", role: "Striker", age: 28, image: player04, loveCount: 45 },
                                { name: "Dominick Dumbleton", role: "Striker", age: 28, image: player05, loveCount: 78 }
                            ].map((player, index) => (
                                <li key={index}>
                                    <a href="#">
                                        <div className="playerFig">
                                            <div className="playerpic">
                                                <div style={{ background: `url(${player.image})` }} className="bgimg"></div>
                                            </div>
                                            <ul className="playerDetails clearfix">
                                                <li>
                                                    <span>{player.name}</span>
                                                    <span><img src={tShirtIcon} alt="shirt" /></span>
                                                </li>
                                                ...
                                                <li className="playerInfo">
                                                    ...
                                                    <span><i className="fa fa-heart"></i>{player.loveCount}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </a>
...
const GallerySection = () => {
    return (
        <section className="gallery">
            ...
            <a className="btn btn-red" href="#">Read More</a>
        </section>
    );
};
